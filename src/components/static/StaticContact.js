...
const StaticContact = (props) => { 
    return (
        <Overlay display={props.display}>
            ...
            <SubContent>
                <TextDetail>
                <p>Thank you for showing interest in our project. 
                    If you are interested in contacting us via email, 
                    please click on the button below to shoot us an email! 
                    We look forward towards hearing from you. </p>
                </TextDetail>
                <GreenLink href="mailto:terreform.19@gmail.com">Email Terreform</GreenLink>
            </SubContent>
        </Overlay> 
    );
}
